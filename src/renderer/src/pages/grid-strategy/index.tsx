...
import {
  getStrategyDisplayStatus,
  getStrategyStatusText,
  canTogglePause
} from '../../utils/grid-strategy-status'
...
function GridStrategyListPage() {
  ...
  const {
    initialized: binance_initialized,
    ticker_prices,
    connectSocket,
    subscribeTicker,
    unsubscribeTicker
  ...
  useEffect(() => {
    ...
    return () => {
      window.removeEventListener(
        ...
        handleStrategyStatusUpdate as EventListener
      )
    }
  }, [])
    ...
    try {
      ...
      for (let i = 0; i < responses.length; i++) {
        ...
        if (response.status === 'success' && response.datum) {
          ...
          const strategies_with_key = list.map(
            (item: any): GridStrategy => ({
              ...item,
  ...
  return (
    <div className="container">
      ...
      {/* 策略列表 */}
      {loading ? (
        <div className="text-muted grid-strategy-loading">加载中...</div>
              ...
              <div className="card-content">
                ...
                <div className="flex items-center space-between mb-12">
                  <div className="flex items-center gap-8">
                    ...
                    <span className="grid-strategy-pair-name">{strategy.trading_pair}</span>
                ...
                <div className="flex flex-col gap-6 mb-12">
                  {strategy._api_key_name && (
                    <div className="flex items-center gap-8">
                      ...
                      <span className="grid-strategy-param-value">{strategy._api_key_name}</span>
                    </div>
                  )}
                  <div className="flex items-center gap-8">
                  ...
                  <div className="flex items-center gap-8">
                    ...
                    <span className="grid-strategy-unit-label">
                      {strategy.trading_pair?.replace('USDT', '')}
                    </span>
                  </div>
                  <div className="flex items-center gap-8">
