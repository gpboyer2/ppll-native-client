...
export const ProfitStatsCard = forwardRef<ProfitStatsCardRef, ProfitStatsCardProps>(
  (props, ref) => {
        ...
        <div className="profit-stats-card-content">
          <div className="profit-stats-card-row">
            <div className="profit-stats-card-item">
              ...
              <span
                className={`profit-stats-card-value ${today_profit > 0 ? 'profit-stats-card-value-long' : today_profit < 0 ? 'profit-stats-card-value-short' : ''}`}
              >
                {today_profit > 0 ? '+' : ''}
                {today_profit.toFixed(2)} U
              </span>
            </div>
            <div className="profit-stats-card-item">
              <span className="profit-stats-card-label">今日交易</span>
              <span className="profit-stats-card-value">{today_trades}</span>
            </div>
            <div className="profit-stats-card-item">
              <span className="profit-stats-card-label">总盈亏</span>
              <span
                className={`profit-stats-card-value ${total_profit > 0 ? 'profit-stats-card-value-long' : total_profit < 0 ? 'profit-stats-card-value-short' : ''}`}
              >
                {total_profit > 0 ? '+' : ''}
                {total_profit.toFixed(2)} U
              </span>
            </div>
            <div className="profit-stats-card-item">
              <span className="profit-stats-card-label">总交易</span>
              <span className="profit-stats-card-value">{total_trades}</span>
            </div>
          </div>
          <div className="profit-stats-card-row">
            <div className="profit-stats-card-item">
              ...
              <span
                className={`profit-stats-card-value ${today_win_rate >= 50 ? 'profit-stats-card-value-long' : today_win_rate < 50 ? 'profit-stats-card-value-short' : ''}`}
              >
            ...
            <div className="profit-stats-card-item">
              ...
              <span
                className={`profit-stats-card-value ${total_win_rate >= 50 ? 'profit-stats-card-value-long' : total_win_rate < 50 ? 'profit-stats-card-value-short' : ''}`}
              >
