                ...
                <div className="smart-config-result">
                    ...
                    <div className="smart-config-market-analysis">
                      <div className="smart-config-analysis-item">
                        ...
                        <span className="value">
                          {NumberFormat.truncateDecimal(optimizationResult.market.support)} USDT
                        </span>
                      </div>
                      <div className="smart-config-analysis-item">
                        <span className="label">阻力位</span>
                        <span className="value">
                          {NumberFormat.truncateDecimal(optimizationResult.market.resistance)} USDT
                        </span>
                      </div>
                      <div className="smart-config-analysis-item">
                      ...
                      <div className="smart-config-analysis-item full-width">
                        ...
                        <span className="advice">
                          {optimizationResult.market.volatility_advice}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="smart-config-section">
                    ...
                    <div className="smart-config-trading-range">
                      ...
                      <div className="smart-config-current-price">
                        ...
                        <span className="value">
                          {NumberFormat.truncateDecimal(optimizationResult.market.current_price)}{' '}
                          USDT
                        </span>
                      </div>
                      {default_params?.position_side === 'LONG' ? (
                        <>
                          <div className="smart-config-range-rule">
                            价格高于{' '}
                            {NumberFormat.truncateDecimal(optimizationResult.market.resistance)}{' '}
                            USDT，继续网格，持续更高收益
                          </div>
                          <div className="smart-config-range-rule">
                            价格低于{' '}
                            {NumberFormat.truncateDecimal(optimizationResult.market.support)}{' '}
                            USDT，暂停开仓，规避下跌风险
                          </div>
                        </>
                      ) : (
                  ...
                  <div className="smart-config-section">
                    ...
                    <table className="smart-config-table">
                      ...
                      <tbody>
                        {optimizationResult.recommended.analysis?.top_list?.map(
                          (config: GridConfigOption, index: number) => (
                            <tr
                              key={index}
                            ...
                            >
                              ...
                              <td>
                                {NumberFormat.truncateDecimal(config.expected_daily_frequency)}
                              </td>
                    ...
                    <div className="smart-config-section">
                      ...
                      <div className="smart-config-selected">
                        ...
                        <div className="smart-config-selected-item">
                          ...
                          <span className="value">
                            数量:{' '}
                            {NumberFormat.truncateDecimal(
                              optimizationResult.recommended.analysis.top_list[selectedConfigIndex]
                                .trade_quantity
                            )}{' '}
                            ({default_params?.trading_pair?.replace('USDT', '') || '--'}) / 金额:{' '}
                            {NumberFormat.truncateDecimal(
                              optimizationResult.recommended.analysis.top_list[selectedConfigIndex]
                                .trade_value
                            )}{' '}
                  ...
                  <div className="smart-config-actions">
                    <button type="button" className="btn btn-outline" onClick={handleRecalculate}>
                      重新计算
                    </button>
                    <button type="button" className="btn btn-primary" onClick={handleApplyConfig}>
                      应用配置
                    </button>
                  </div>
                </div>
