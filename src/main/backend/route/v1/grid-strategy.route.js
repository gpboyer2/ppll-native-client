...
router.post(
    "/deletes",
    vipMiddleware.validateVipAccess,
    gridStrategyController.deletes,
);
...
router.post(
    "/optimize",
    vipMiddleware.validateVipAccess,
    gridStrategyController.optimize_params,
);
