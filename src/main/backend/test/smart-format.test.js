...
console.log(
    "  支撑位 3250.1234 ->",
    smartFormat(3250.1234, eth_precision, true, eth_current_price),
);
console.log(
    "  阻力位 3400.5678 ->",
    smartFormat(3400.5678, eth_precision, true, eth_current_price),
);
console.log(
    "  网格间距 35.123 ->",
    smartFormat(35.123, eth_precision, true, eth_current_price),
);
console.log("");
...
console.log(
    "  支撑位 95000.678 ->",
    smartFormat(95000.678, btc_precision, true, btc_current_price),
);
console.log(
    "  阻力位 99500.123 ->",
    smartFormat(99500.123, btc_precision, true, btc_current_price),
);
console.log(
    "  网格间距 123.456 ->",
    smartFormat(123.456, btc_precision, true, btc_current_price),
);
console.log("");
...
console.log(
    "  支撑位 5.179929 ->",
    smartFormat(5.179929, uni_precision, true, uni_current_price),
);
console.log(
    "  阻力位 6.341319 ->",
    smartFormat(6.341319, uni_precision, true, uni_current_price),
);
console.log(
    "  网格间距 0.036 ->",
    smartFormat(0.036, uni_precision, true, uni_current_price),
);
console.log("");
...
console.log(
    "  支撑位 0.0000170 ->",
    smartFormat(0.000017, sats_precision, true, sats_current_price),
);
console.log(
    "  阻力位 0.0000200 ->",
    smartFormat(0.00002, sats_precision, true, sats_current_price),
);
console.log(
    "  网格间距 0.0000015 ->",
    smartFormat(0.0000015, sats_precision, true, sats_current_price),
);
console.log("");
...
console.log("=== 数量格式化测试 ===");
console.log(
    "ETH 数量 0.123456 (stepSize 0.001) ->",
    smartFormat(0.123456, { stepSize: 0.001 }, false),
);
console.log(
    "BTC 数量 0.00123456 (stepSize 0.00001) ->",
    smartFormat(0.00123456, { stepSize: 0.00001 }, false),
);
console.log(
    "SATS 数量 2994210 (stepSize 1) ->",
    smartFormat(2994210, { stepSize: 1 }, false),
);
