...
const optionsV1 = {
    definition: {
        ...
        info: {
            ...
            description:
                "PPLL量化交易系统 API - 提供网格策略、订单管理、账户管理等核心功能",
            version: "1.0.0",
        },
    },
...
function swaggerDocs(app, port) {
    console.log(
        `:::::::::::::::: SWAGGER RUNNING ON http://localhost:${port}/api/v1/docs`,
    );
    console.log(
        `:::::::::::::::: 模块过滤示例: http://localhost:${port}/api/v1/docs?module=user`,
    );
    console.log(
        `:::::::::::::::: 完整文档(JSON): http://localhost:${port}/api/v1/docs-json?module=user`,
    );
