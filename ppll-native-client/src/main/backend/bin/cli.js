...
const repo =
    "https://github.com/gulalicelik/nodejs-express-sequelize-mysql-api-boilerplate.git";
...
async function setup() {
    try {
        ...
        console.log(
            `edit config/database.json file and change your database name, username and password`,
        );
