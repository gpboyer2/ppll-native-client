...
router.get(
    "/futures-only",
    tradingPairsComparisonController.getFuturesOnlyPairs,
);
...
router.get(
    ...
    tradingPairsComparisonController.getComprehensiveReport,
);
...
router.get(
    "/analyze",
    tradingPairsComparisonController.analyzeTradingPairAvailability,
);
...
router.get(
    "/futures-pairs",
    tradingPairsComparisonController.getFuturesTradingPairs,
);
 ...
 */
router.get(
    "/coin-m-futures-pairs",
    tradingPairsComparisonController.getCoinMFuturesTradingPairs,
);
