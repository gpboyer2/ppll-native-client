...
router.get(
    ...
    bannedIpController.getBannedIps,
);
...
router.delete(
    "/unban",
    validateMiddleware(ipQuerySchema),
    bannedIpController.unbanIp,
);
...
router.get(
    "/detail",
    validateMiddleware(ipQuerySchema),
    bannedIpController.getIPBanDetail,
);
...
router.post(
    "/batch-unban",
    validateMiddleware(batchUnbanSchema),
    bannedIpController.batchUnbanIP,
);
...
router.post(
    "/trusted-ips",
    validateMiddleware(trustedIPSchema),
    bannedIpController.addTrustedIPAddress,
);
...
router.delete(
    "/trusted-ips/remove",
    validateMiddleware(ipQuerySchema),
    bannedIpController.removeTrustedIPAddress,
);
