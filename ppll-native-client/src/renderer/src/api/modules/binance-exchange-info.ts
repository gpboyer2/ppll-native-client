...
export class BinanceExchangeInfoApi {
   ...
   * 获取交易所信息
   */
  static async getExchangeInfo(params?: {
    api_key?: string
    api_secret?: string
   ...
   * 强制更新
   */
  static async forceUpdate(params?: {
    api_key?: string
    api_secret?: string
  }): Promise<Response<any>> {
   ...
   * 获取溢价指数
   */
  static async getPremiumIndex(params: {
    api_key: string
    api_secret: string
  }): Promise<Response<any>> {
   ...
   * 获取下市永续合约
   */
  static async getDelistingPerpetualContracts(params: {
    api_key: string
    api_secret: string
    days_ahead?: number
  }): Promise<Response<any>> {
   ...
   * 获取下市计划测试
   */
  static async getDelistScheduleTest(params?: {
    api_key?: string
    api_secret?: string
  }): Promise<Response<any>> {
