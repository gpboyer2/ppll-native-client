    ...
    <>
      ...
      <div className="grid-strategy-form-section">
        ...
        <div className="grid-strategy-form-grid">
          ...
          {/* 做多开仓数量 */}
          <div
            className={`grid-strategy-form-field ${isLongOnlyField() ? '' : 'grid-strategy-field-hidden'}`}
          >
          ...
          {/* 做空开仓数量 */}
          <div
            className={`grid-strategy-form-field ${isShortOnlyField() ? '' : 'grid-strategy-field-hidden'}`}
          >
      ...
      <div className="grid-strategy-form-section">
        ...
        <div className="grid-strategy-form-grid">
          ...
          <div className="grid-strategy-form-field">
            ...
            />
            <div className="help">
              系数越大，价格变动时的触发价格会下放得更低，为0时固定使用网格差价
            </div>
          </div>
        </div>
        ...
        <div className="grid-strategy-risk-subsection">
          ...
          <p className="grid-strategy-risk-subsection-desc">
            设置具体的绝对价格值作为网格运行的上限和下限
          </p>
          <div className="grid-strategy-form-grid">
            {/* 价格上限 */}
            <div className="grid-strategy-form-field">
          ...
          <div className="grid-strategy-form-field">
            ...
            <NumberInput
              ...
              onChange={(value) =>
                updateFormField(
                  'polling_interval',
                  typeof value === 'number' ? value : parseFloat(value || '10000')
                )
              }
              min={0}
              step={100}
          ...
          <div className="grid-strategy-form-field">
            ...
            <NumberInput
              ...
              onChange={(value) =>
                updateFormField(
                  'avg_cost_price_days',
                  typeof value === 'number' ? value : parseFloat(value || '30')
                )
              }
              min={1}
              max={365}
        ...
        <div className="grid-strategy-form-toggles">
          ...
          <div className="grid-strategy-form-toggle">
            <div className="grid-strategy-form-toggle-info">
              ...
              <div className="help">
                当网格仓位记录为空但实际持有仓位时，在价格趋势中优先执行平仓
              </div>
            </div>
            <label className="grid-strategy-toggle-switch">
              <input
