...
export const AccountInfoCard = forwardRef<AccountInfoCardRef, AccountInfoCardProps>(
  (props, ref) => {
        ...
        <div className="account-info-card-content">
          <div className="account-info-card-row">
            <div className="account-info-card-item">
              ...
              <span
                className={`account-info-card-value ${is_balance_low ? 'account-info-card-value-warning' : ''}`}
              >
          ...
          <div className="account-info-card-row">
            ...
            <div className="account-info-card-item">
              ...
              <span
                className={`account-info-card-value ${displayData.unrealized_profit > 0 ? 'account-info-card-value-long' : displayData.unrealized_profit < 0 ? 'account-info-card-value-short' : ''}`}
              >
                {displayData.unrealized_profit > 0 ? '+' : ''}
                {displayData.unrealized_profit.toFixed(2)} U
              </span>
            </div>
          </div>
        </div>
