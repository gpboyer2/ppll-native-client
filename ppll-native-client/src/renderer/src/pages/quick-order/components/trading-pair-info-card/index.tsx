    ...
    <div className="trading-pair-info-card">
      ...
      <div className="trading-pair-info-card-controls">
        ...
        <div className="trading-pair-info-card-control-group">
          ...
          <NumberInput
            ...
            value={leverage}
            onChange={(value) =>
              on_leverage_change(Math.max(1, Math.min(125, parseInt(String(value)) || 1)))
            }
            min={1}
            max={125}
      ...
      <div className="trading-pair-info-card-content">
        <div className="trading-pair-info-card-item">
          ...
          <span className="trading-pair-info-card-value">{display_mark_price}</span>
        </div>
        <div className="trading-pair-info-card-item">
      ...
      <div className="trading-pair-info-card-prices">
        <div className="trading-pair-info-card-price-section">
          <div className="trading-pair-info-card-price-section-title">
            <span>多单仓位详情</span>
            <span className="trading-pair-info-card-value-long">
              ({current_pair_long_amount.toFixed(2)} U)
            </span>
          </div>
          <div className="trading-pair-info-card-price-list">
            <div className="trading-pair-info-card-price-item">
              ...
              <span className="trading-pair-info-card-price-value">
                {formatPrice(long_position?.breakEvenPrice)}
              </span>
            </div>
            <div className="trading-pair-info-card-price-item">
              <span className="trading-pair-info-card-price-label">开仓</span>
              <span className="trading-pair-info-card-price-value">
                {formatPrice(long_position?.entryPrice)}
              </span>
            </div>
            <div className="trading-pair-info-card-price-item">
              <span className="trading-pair-info-card-price-label">强平</span>
              <span className="trading-pair-info-card-price-value trading-pair-info-card-price-value-danger">
                {formatPrice(long_position?.liquidationPrice)}
              </span>
            </div>
            <div className="trading-pair-info-card-price-item">
              <span className="trading-pair-info-card-price-label">盈利</span>
              <span
                className={`trading-pair-info-card-price-value ${getProfitClassName(typeof long_profit === 'number' ? String(long_profit) : long_position?.unrealizedProfit)}`}
              >
                {typeof long_profit === 'number'
                  ? formatProfit(String(long_profit))
                  : formatProfit(long_position?.unrealizedProfit)}
              </span>
            </div>
          </div>
        </div>
        <div className="trading-pair-info-card-price-section">
          <div className="trading-pair-info-card-price-section-title">
            <span>空单仓位详情</span>
            <span className="trading-pair-info-card-value-short">
              ({current_pair_short_amount.toFixed(2)} U)
            </span>
          </div>
          <div className="trading-pair-info-card-price-list">
            <div className="trading-pair-info-card-price-item">
              <span className="trading-pair-info-card-price-label">保本</span>
              <span className="trading-pair-info-card-price-value">
                {formatPrice(short_position?.breakEvenPrice)}
              </span>
            </div>
            <div className="trading-pair-info-card-price-item">
              <span className="trading-pair-info-card-price-label">开仓</span>
              <span className="trading-pair-info-card-price-value">
                {formatPrice(short_position?.entryPrice)}
              </span>
            </div>
            <div className="trading-pair-info-card-price-item">
              <span className="trading-pair-info-card-price-label">强平</span>
              <span className="trading-pair-info-card-price-value trading-pair-info-card-price-value-danger">
                {formatPrice(short_position?.liquidationPrice)}
              </span>
            </div>
            <div className="trading-pair-info-card-price-item">
              <span className="trading-pair-info-card-price-label">盈利</span>
              <span
                className={`trading-pair-info-card-price-value ${getProfitClassName(typeof short_profit === 'number' ? String(short_profit) : short_position?.unrealizedProfit)}`}
              >
                {typeof short_profit === 'number'
                  ? formatProfit(String(short_profit))
                  : formatProfit(short_position?.unrealizedProfit)}
              </span>
            </div>
          </div>
        </div>
