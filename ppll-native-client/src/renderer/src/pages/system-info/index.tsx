          ...
          <div className="card-content">
            <div className="info-item-list">
              ...
              <InfoItem
                ...
                status="warning"
                style={{
                  background: 'color-mix(in srgb, #17a2b8 20%, var(--color-bg))',
                  color: '#17a2b8'
                }}
              />
              <InfoItem
                label="应用描述"
                value={staticInfo.appDescription}
          ...
          <div className="card">
            ...
            <div className="card-content">
              <div className="info-item-list">
                ...
                <div
                  className="info-item"
                  style={{ alignItems: 'flex-start', flexDirection: 'column', gap: '4px' }}
                >
