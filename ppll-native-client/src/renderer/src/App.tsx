...
function RouteLogger() {
  ...
  useEffect(() => {
    ...
    console.log(`[路由 #${routeId}] ${prevPath} → ${location.pathname}`)
        ...
        <Router future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
          ...
          <ApiKeyGuard>
            ...
            <Routes>
              ...
              <Route
                path="/plugins/u-grid-t"
                element={<Navigate to={ROUTES.GRID_STRATEGY} replace />}
              />
              {/* 快捷开单插件重定向 */}
              <Route
                path="/plugins/quick-order"
                element={<Navigate to={ROUTES.QUICK_ORDER} replace />}
              />
