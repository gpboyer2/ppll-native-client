 ...
 */
const calculateExpectedProfit = (latestPrice, { gridTradeQuantity, grid_price_difference }) => {
  let currentTradeValue = bigNumber(latestPrice).times(gridTradeQuantity);
  let expectedRiseTradeValue = bigNumber(latestPrice).plus(grid_price_difference).times(gridTradeQuantity);
