    ...
    <div className="info-card">
      ...
      <div className="info-card-body">
        ...
        <div className="info-row">
          ...
          <span className="info-value">
            {current_price ? (
              ((grid_price_difference / current_price) * 100).toFixed(3)
            ) : '-'}% / {grid_price_difference.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} USDT
          </span>
        </div>
        ...
        {margin_type && (
          <div className="info-row">
            ...
            <span className="info-value">
              {margin_type === 'cross' ? 'CROSS (全仓)' : margin_type === 'isolated' ? 'ISOLATED (逐仓)' : margin_type.toUpperCase()}
            </span>
          </div>
        )}
      </div>
