    ...
    <div className="container developer-console-page">
      ...
      <div className="grid-2">
          ...
          <div className="card-content">
            <div className="info-item-list">
              ...
              <div className="info-item">
                ...
                <span className={`info-status ${nodejsService.isHealthy ? 'healthy' : 'unhealthy'}`}>
          ...
          <div className="card-content">
            <div className="info-item-list">
              ...
              <div className="info-item">
                ...
                <span className="info-value info-value-monospace">
                  {nodejsService.serverDir}
                </span>
              </div>
              <div className="info-item">
                <span className="info-label">服务目录（解析）</span>
                <span className="info-value info-value-monospace">
                  {nodejsService.resolvedDir}
                </span>
              </div>
              <div className="info-item">
        ...
        <div className="card">
          ...
          <div className="card-content">
            <div className="info-item-list">
              {debugInfo.environment && Object.entries(debugInfo.environment).map(([key, value]: [string, any]) => (
        ...
        <div className="card-header">
          <div className="log-viewer-header">
            <div className="flex items-center gap-8">
              ...
              <span>实时日志</span>
              {debugLogs && (
                <span className="log-max-lines-hint">
                  (最近 {debugLogs.max_lines} 行)
                </span>
              )}
            </div>
