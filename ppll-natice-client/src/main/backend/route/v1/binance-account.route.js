...
router.get(
    ...
    binanceAccountController.getUSDMFuturesAccount,
);
...
router.get(
    "/spot",
    vipMiddleware.validateVipAccess,
    binanceAccountController.getSpotAccount,
);
...
router.get(
    "/coinm-futures",
    vipMiddleware.validateVipAccess,
    binanceAccountController.getCoinMFuturesAccount,
);
...
router.post(
    "/set-leverage",
    vipMiddleware.validateVipAccess,
    binanceAccountController.setLeverage,
);
...
router.post(
    "/generate-listen-key",
    vipMiddleware.validateVipAccess,
    binanceAccountController.generateListenKey,
);
...
router.put(
    ...
    vipMiddleware.validateVipAccess,
    binanceAccountController.keepAliveListenKey,
);
...
router.get(
    "/position-risk",
    vipMiddleware.validateVipAccess,
    binanceAccountController.getPositionRisk,
);
