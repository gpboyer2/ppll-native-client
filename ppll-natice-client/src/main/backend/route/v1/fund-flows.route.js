...
router.get(
    ...
    fundFlowsController.getContractFundFlows,
);
...
router.get(
    "/trend-prediction",
    vipMiddleware.validateVipAccess,
    fundFlowsController.getTrendPrediction,
);
...
router.get(
    "/distribution",
    vipMiddleware.validateVipAccess,
    fundFlowsController.getFundFlowDistribution,
);
...
router.get(
    "/analysis",
    vipMiddleware.validateVipAccess,
    fundFlowsController.getFundFlowAnalysis,
);
...
router.get(
    "/percentage",
    vipMiddleware.validateVipAccess,
    fundFlowsController.getFundFlowPercentage,
);
 ...
 */
router.get(
    "/coinank_open-interest-history",
    vipMiddleware.validateVipAccess,
    fundFlowsController.getOpenInterestHistory,
);
...
router.get(
    ...
    vipMiddleware.validateVipAccess,
    fundFlowsController.getOpenInterestByExchange,
);
