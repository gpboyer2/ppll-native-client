...
export function TextInput(props: TextInputProps) {
  ...
  return (
    <PPLLMantineProvider>
      <MantineTextInput {...rest} onChange={handleChange} styles={inputStyles} />
    </PPLLMantineProvider>
  )
}
...
export function NumberInput(props: NumberInputProps) {
  ...
  return (
    <PPLLMantineProvider>
      <MantineNumberInput {...rest} onChange={onChange} styles={inputStyles} />
    </PPLLMantineProvider>
  )
}
...
export function PasswordInput(props: PasswordInputProps) {
  ...
  return (
    <PPLLMantineProvider>
      <MantinePasswordInput {...rest} onChange={handleChange} styles={inputStyles} />
    </PPLLMantineProvider>
  )
}
