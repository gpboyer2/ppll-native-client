    ...
    <div className="strategy-detail-page container">
      <div className="detail-header">
        <div className="detail-header-left">
          <Link to={ROUTES.GRID_STRATEGY} className="back-link">
            ← 返回
          </Link>
          <div className="strategy-info">
            <div className="strategy-title-row">
              <span
                className={`position-badge ${strategy.position_side === 'LONG' ? 'long' : 'short'}`}
              >
            ...
            <div className="strategy-meta">
              ...
              <span className="status-text">{strategy_status_text}</span>
              <span className="divider">|</span>
              <span className="meta-text">
                创建于 {new Date(strategy.created_at).toLocaleDateString()}
              </span>
              <span className="divider">|</span>
      ...
      <div className="detail-content">
        ...
        <div className="side-section">
          ...
          <FeeDetailCard total_fee={strategy.total_fee} funding_fee={strategy.funding_fee} />
        </div>
      </div>
    </div>
  )
