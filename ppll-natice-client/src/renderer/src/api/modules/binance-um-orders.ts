...
export class OrdersApi {
   ...
   * 批量检查
   */
  static async batchInspect(data: { api_key: string; api_secret: string }): Promise<Response<any>> {
   ...
   * 获取U本位合约胜率统计
   */
  static async getUmWinRateStats(params: { api_key: string }): Promise<Response<WinRateStats>> {
